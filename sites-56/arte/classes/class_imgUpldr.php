...
class imgUpldr {
	...
	var $_width = 0; // Ancho máximo por defecto
	var $_height = 0; // Alto máximo por defecto
	var $_size = 200000; // Peso máximo. MAX_FILE_SIZE sobrescribe este valor
	var $_name = "imagen"; // Nombre por defecto 
	var $_dest = "";
	private $_img;
	private $_ext;
	private $_r = "";
			...
			switch($error) {
				case 0:
					...
					if ($this->validaTipo()) {
						...
						error_log("aspecto imagen=".$ratio);
						...
						if ($this->_width > 0) {
							...
							$alto_max = $this->_width / $ratio;
						} else {
							$ancho_max = $this->_height * $ratio;
...
//							}
				...
				case 1:
				case 2:
				$this->_r = "La imagen excede el tamano maximo soportado";
				break;
				case 3:
				$this->_r = "La imagen no se subio correctamente";
				break;	
				case 4:
				$this->_r = "Se debe seleccionar un archivo";
				break;	
			}
		} else {
