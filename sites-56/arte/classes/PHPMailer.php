...
class PHPMailer
{
     ...
     * @var string
     */
    public $From = 'noreply@arteorganizer.com';
     ...
     * @var string
     */
    public $Username = 'noreply@arteorganizer.com';
     ...
     * @var string
     */
    public $Password = 'nr4rt30rg4n1z3r';
	...
	/**
	 * Pone el Asunto del correo
	 * @param string $texto
	 */
	public function setSubject($texto) {
		$this->Subject = $texto;
	}
