...
<script language="JavaScript" type="text/javascript">
	$(document).ready(function() {
		...
		$('#cobrar').click(function() {
			envia('A', $('#importe').val() * 100);
		});
	});

	function envia(opcion, importe) {
		var url = "../../propre.php";
		// url = "../propre.php";
		$(".title_tarea1").esperaDiv('muestra');
		if (importe > $("#valor").val()) {
			alert("No se permiten valores superiores al que tiene la operaci\u00F3n");
			$('#importe').val($("#valor").val() / 100).focus();
