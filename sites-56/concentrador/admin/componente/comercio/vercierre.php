...
<script type='text/javascript'>
	function cambiaD(val) {
		...
		else if (val == 'C') $("#cierr").css('display', 'inline');
		else $("#fact").css('display', 'inline');
	}
	...
	$(document).ready(function() {
		...
		$('#resultF tbody').load('componente/comercio/resultado.php', {
			comercioId: '<?php echo $comercId ?>',
			trans: "F",
			ano: <?php echo $ano; ?>
		});
...
<div class="escoge" style="text-align: center;line-height: 24px;">Mostrar:
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="radio" id="mostrT" onclick="cambiaD(this.value)" name="mostr" value="T" /><label for="mostrT">Transferencias</label>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="radio" id="mostrF" onclick="cambiaD(this.value)" name="mostr" value="F" /><label for="mostrF">Facturas</label> </div>
...
<div id="fact" style="float: left;width: 100%;display:none;">
	<table cellspacin="0" cellpadding="0" align="center" id="resultF" width="400">
		<thead>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
