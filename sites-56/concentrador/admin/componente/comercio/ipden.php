...
$vista = "select i.idips id, i.ip, i.ip 'geo{geoip}', (select distinct nombre from tbl_reserva r where i.identificador = r.codigo and r.id_comercio = c.idcomercio) nombre,
