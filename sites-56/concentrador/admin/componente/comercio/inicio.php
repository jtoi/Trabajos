...
$query = "select mensaje from tbl_mensajes where fechaInicio <= $fechaNow and (idcomercio = 'todos' or idcomercio in (". $_SESSION['idcomStr'] .")) and fechaFin >= $fechaNow and activo = 1 order by fechaInicio desc";
// echo $query;
$temp->query($query);
$cant = $temp->num_rows();
...
// 	$PG->title     = _VENTAS_X_TIENDA;
	...
	if ($cant > 0 && $_SESSION['comercio'] != 'todos') {
		...
		$flot .= "<div id='toto'><div id='cierrame'><span id='lax'>X</span></div><div id='noticiaA'><div id='noticiaT'>$tituloN</div><ul>";
		// $contenido .= "<div id='noticiaA'><div id='noticiaT'>$tituloN</div><ul>";
	...
	$contenido .= $flot."<div id='noticiaA'>Descarga el <a href='https://www.administracomercios.com/documentos/ManualUsuario.pdf'>Manual de Usuario</a><br />Descarga la <a href='https://www.administracomercios.com/documentos/GuiaUsuario.pdf'>Guía de Usuario para cobros online</a><hr /></div>";
