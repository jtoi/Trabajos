					...
					<td colspan="3" id="nido" align="center">{corte1}<!--Termina partes 2-->
						<table id="Contenido" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr id="fecha1tr">
								...
								<td class="izquierda"><input readonly="true" name="fecha1" value="{fecha1}" type="text" class="formul" id="fecha1" size="12" maxlength="10" />&nbsp;(dd/mm/yyyy)</td>
							</tr>
							{corte1}<!--Termina partes 9-->
							<tr id="fecha2tr">
								<td class="derecha">{_REPORTE_FECHA_FIN}: </td>
								<td class="izquierda"><input readonly="true" name="fecha2" value="{fecha2}" type="text" class="formul" id="fecha2" size="12" maxlength="10" />&nbsp;(dd/mm/yyyy)</td>
							</tr>
