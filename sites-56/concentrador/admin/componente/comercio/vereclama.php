...
if (isset($d['comercio']) && isset($_FILES["fileup"]) && $_FILES["fileup"]["error"] == 0) {
	...
	if (!array_key_exists($ext, $allowed)) echo "<div style=\"text-align:center; margin-top: 20px; color:red; font-family:Arial sans-serif; font-size:11px\">Error: Por favor entre un fichero de reclamaci&oacute;n v&aacute;lido, puede ser en formato jpg, jpeg o pdf.</div>";
	else {
...
$html->inFile("Reclamaci&oacute;n", "fileup");
