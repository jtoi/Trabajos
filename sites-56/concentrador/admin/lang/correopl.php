...
define(_TEXTO4, 'En la solicitud de transferencia no debe aparecer en ninguna parte la palabra Cuba o el nombre de empresa estatal o servicio alguno que tenga que ver con Cuba, si esto ocurriera, Caribbean Online no se hace responsable de que la transferencia llegue a su destino. Así mismo, debe indicar en algún lugar de la orden de transferencia que la transferencia corresponde al pago de la FACTURA: %oper%.');
...
define(_AVISO_NOTA, 'Muy Importante!!!: En la transferencia, haga constar que ocurre por solicitud del aviso No. {aviso}.<br>En la solicitud de transferencia no debe aparecer en ninguna parte la palabra Cuba o el nombre de empresa estatal o servicio alguno que tenga que ver con Cuba, si esto ocurriera Caribbean Online no se hace responsable de que la transferencia llegue a su destino.');
