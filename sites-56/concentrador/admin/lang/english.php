...
define(_MENU_ADMIN_DOCLEGAL, 'Legal Documentation');
...
define(_MENU_ADMIN_TRANSFERENCIA_MOD, 'Request for Payment by Bank Transfer');
...
define(_MENU_ADMIN_CAMBIOCUC,'CUP Exchange');
...
define(_MENU_ADMIN_LOTE, 'Batch Payments');
define(_MENU_ADMIN_PCANT, 'Pasarela por num. operaciones');
define(_MENU_ADMIN_PTMPO, 'Pasarela por tiempo');
define(_MENU_ADMIN_SFACT, 'Upload Bills');
define(_MENU_ADMIN_SRECLAM, 'Upload Claims');
...
define(_GRUPOS_ALERTA_FACT, 'This transacction isn\`t a transfer or Preauthorization');
...
define(_COMERCIO_FACT_SI, 'Your request for payment by bank transfer has been sent for review.');
...
define(_REPORTE_REF_BBVA, 'Bank reference');
...
define(_REPORTE_APOBADA, 'Approved');
define(_REPORTE_CANCELADA, 'Cancelled');
...
define(_REPORTE_SOLRECLAMACION, 'Claim request');
...
//Correos
define(_MENU_ADMIN_DOCUMENTACION, "Estimado cliente:<br><br>
