...
if ($_SESSION['grupo_rol'] < 10) $html->inSelect(_MENU_ADMIN_COMERCIO, 'comer', 6, $q, $comer, null, null, "multiple='multiple'");
...
$where = "where i.idCom = c.id and c.id in (".implode(",",$comer).") 
			and i.ip != '127.0.0.1'
			and fecha between ".to_unix($fecha1)." and ".(to_unix($fecha2) + (24*60*60))." 
...
if ($_SESSION['grupo_rol'] < 4) $columnas[] = array(_MENU_ADMIN_COMERCIO, "comercio", "", "center", "center" );
