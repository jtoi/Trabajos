var mMessage="Campo Requerido";var pPrompt="Error: ";var pDate="Fecha inválida";var pAlphanumeric="Ha escrito caractéres que no son válidos";var pAlphabetic="Cadena inválida";var pInteger="Número inválido";var pNumber="Número inválido";var pPhoneNumber="Escriba un número de teléfono válido";var pEmail="Escriba un email válido";var pName="Sólo caracteres, números o espacio en blanco";var pBlanco="No se permite esta entrada sin dato.";var pMoney="Debe entrar un valor correspondiente a dinero. \n Revise que sólo tenga un punto decimal";var pUrl="Usted ha insertado caracteres prohibidos, use sólo números y letras del alfabeto sin espacios en blanco";
var msg;var defaultEmptyOK=false;var digits="0123456789";var lowercaseLetters="()abcdefghijklmnopqrs&?=%"+String.fromCharCode(13)+String.fromCharCode(10)+String.fromCharCode(34)+"tuvwxyzáéí­óúüñ.,-_'` :";var uppercaseLetters="ABCDEFGHIJKLMNOPQRSTUVWXYZÁÉÍÓÚÂ½\/ÁÉÍÓÚÜÑ";var urlcar="-áéíóúäëïöüñÑÁÉÍÓÚÄËÏÖÜ&\/&%Â¡Â²Â³Â¤?Â¼Â½ ";var whitespace=" \t\n\r";var phoneChars="()+- ";var diasPorMes=new Array(12);diasPorMes[1]=31;diasPorMes[2]=29;diasPorMes[3]=31;diasPorMes[4]=30;diasPorMes[5]=31;diasPorMes[6]=30;diasPorMes[7]=31;diasPorMes[8]=31;diasPorMes[9]=30;diasPorMes[10]=31;diasPorMes[11]=30;diasPorMes[12]=31;function makeArray(n){for(var i=1;i<=n;i++){this[i]=0;}
return this;}
