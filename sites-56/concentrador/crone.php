...
// 			print_r($arrRecl);
			...
			$corCreo->set_message("El comercio {$com[2]} tiene 3 o más reclamaciones en el período de "
						."3 meses. Las operaciones son ".implode(", ", $arrRecl));
			$corCreo->set_subject("Aviso de 3 reclamaciones en menos de 3 meses");
			$corCreo->envia(45);
...
// 						."3 meses. Las operaciones son ".implode(", ", $arrRecl));
		...
		$corCreo->set_message($sale);
		$corCreo->set_subject("Avisos de Cierres");
		$corCreo->envia(45);
