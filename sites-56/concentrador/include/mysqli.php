...
error_log('MySQL::queryError: '. $this->_errorNum.' - '.$this->_errorMsg.$datcorr);
			sendTelegram("Error de Mysql: P�gina: ".$_SERVER['HTTP_REFERER'].' \n<br>MySQL::queryError: '. $this->_errorNum.' - '.$this->_errorMsg.$datcorr, null);
			error_log("Error de Mysql: P�gina: ".$_SERVER['HTTP_REFERER'].' \n<br>MySQL::queryError: '. $this->_errorNum.' - '.$this->_errorMsg.$datcorr);
			// $corr = new correo();
			// $corr->todo(43, "Error de Mysql", 'P�gina: '.$_SERVER['HTTP_REFERER'].' \n<br>MySQL::queryError: '. $this->_errorNum.' - '.$this->_errorMsg.$datcorr);
			return false;
		}
