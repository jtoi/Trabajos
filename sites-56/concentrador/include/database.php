...
class database {
	...
	*/
	function database( $host='localhost', $user, $pass, $db='', $table_prefix='#_', $goOffline=true ) {
...
//		if (strpos($this->_sql, "select")) {
//			echo str_replace("select ", "select SQL_CALC_FOUND_ROWS ", $this->_sql);
//			
//		}
		return $this->_cursor;
	}
