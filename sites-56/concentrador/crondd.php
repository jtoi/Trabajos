...
//			print_r($arrSal);
			...
			if (count($arrSal) == 0) {
				$q = "select idcomercio, idtransaccion, fecha 'fechaCierre' from tbl_transacciones where idcomercio = '{$com[1]}'"
...
echo $com[2]."<br>";
				...
				$q = "select sum(euroEquiv) suma from tbl_transacciones where estado = 'A' and idcomercio = '".$com[1]."' and tipoEntorno = 'P'
					and fecha > $ffeUn";
				$temp->query($q);
				$valeT = $temp->f('suma');
				echo $q."<br>";
