...
if (isset($d['firma']) && isset($d['operacion']) && $d['operacion'] == 'P') {//operación
...
} elseif (isset($d['firma']) && isset($d['operacion']) && $d['operacion'] == 'S' && strlen($d['motivo']) < 8) { //solicitud de devolución
