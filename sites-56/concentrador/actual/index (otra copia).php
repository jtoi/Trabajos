...
function muestraError ($etiqueta, $textoCorreo) {
	...
	$saleErrores = ''; $pase=false;	

	if (count($inicio->arrPD) > 0) {
	...
	// if ($temp->num_rows()>0) {
	// 	echo "<form name='retorno' action='"._ESTA_URL."/admin/index.php?componente=comercio&pag=pago' method='post'>
...
en los datos enviados:<br /><h3>Su comercio no tiene disponible esta forma de cobro. Consulte con los Administradores.</h3>por favor consulte a su comercio.<br /><br />
