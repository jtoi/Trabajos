...
define(_MENU_ADMIN_OLDTRANSACCIONES, 'Transacciones Viejas');
...
define(_MENU_ADMIN_CAMBIOCUC,'Cambio del CUC');
...
define(_GRUPOS_ALERTA_FACT, 'Esta transacción no es una transferencia');
...
define(_COMERCIO_FACT_SI, 'La Factura ha sido enviada satisfactoriamente.');
...
define(_REPORTE_REF_BBVA, 'Referencia<br />del Banco');
...
define(_PAGO_TARJETA, "Escoja la tarjeta con la que el cliente pagará");
