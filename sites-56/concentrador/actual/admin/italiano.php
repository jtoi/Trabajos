...
define(_MENU_ADMIN_CAMBIOCUC,'Scambio CUC');
...
define(_GRUPOS_ALERTA_FACT, 'Questa Transazione non &eacute; un Bonifico');
...
define(_COMERCIO_FACT_SI, 'La Fattura è stata inviata correttamente.');
...
define(_REPORTE_REF_BBVA, 'Riferimenti<br />del Banco');
...
define(_REPORTE_PENDIENTE, 'Pendente');
