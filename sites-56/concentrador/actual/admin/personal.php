...
$ancho = '600';
//$temp->_debug=true;
$qg = ' select a.idadmin, a.nombre, a.login, a.email, r.idrol, a.activo, correoT, TimeZone, usequery'
...
$html->inSelect(_PERSONAL_FECHA, 'fecfor', 3, $valorIni);
$valorIni = array(
		array('H:i:s', date('H:i:s')),
		array('g:i:s a', date('g:i:s a')),
);
$html->inSelect(_PERSONAL_HORA, 'horfor', 3, $valorIni);
$valorIni = array(
