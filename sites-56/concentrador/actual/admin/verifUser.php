...
<script>
	...
	if ($paso == 2){
		...
		if (verificacCorreo($email, $ip) === 'ok') { //correo perfecto se muestra el formulario para el código
			$muela2 .= "Por favor espere unos minutos para recibir el c&oacute;digo en el correo indicado<br>Please wait for a few minutes to receive the code<br><br>".$muela3;
		} else {
			$paso = 2;
