...
var msg;var defaultEmptyOK=false;var digits="0123456789";var lowercaseLetters="()abcdefghijklmnopqrs&?=%"+String.fromCharCode(13)+String.fromCharCode(10)+String.fromCharCode(34)+"tuvwxyzáéíóúüñ.,-_'` :";var uppercaseLetters="ABCDEFGHIJKLMNOPQRSTUVWXYZï¿½ï¿½ï¿½ï¿½\/ÁÉÍÓÚÜÑ";var urlcar="áéíóúäëöïüñÑÁÉÍÓÚÄËÏÖÜ&\/&%¡²³¤?¼½ ";var whitespace=" \t\n\r";var phoneChars="()+- ";var diasPorMes=new Array(12);diasPorMes[1]=31;diasPorMes[2]=29;diasPorMes[3]=31;diasPorMes[4]=30;diasPorMes[5]=31;diasPorMes[6]=30;diasPorMes[7]=31;diasPorMes[8]=31;diasPorMes[9]=30;diasPorMes[10]=31;diasPorMes[11]=30;diasPorMes[12]=31;function makeArray(n){for(var i=1;i<=n;i++){this[i]=0;}
return this;}
...
{i++;}
if(s.chartAt(i) == '"') return false;if(s.chartAt(i) == "'") return false;
