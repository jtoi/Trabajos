...
if(document.all || document.layers || document.getElementById){
	...
	document.write("<script language=\"JavaScript1.2\" src=\""+dqm__codebase+"tbrowser_"+brn+".js\"></script>");document.close();
};
...
function q28(){
 // call to my fuction, thanks OPEN CUBE!!!!
};
function q32(index){
...
function q100(){
	q101=0;
	while(eval("window.dqm__maindesc"+q101))q101++;
	q105=new Array(q101);
	for(e=0;e<q101;e++)(eval("window.dqm__subdesc"+e+"_0"))? q105[e]=true:q105[e]=false;
	return q101;
};
