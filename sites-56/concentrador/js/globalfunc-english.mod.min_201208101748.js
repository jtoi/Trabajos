var mMessage="Required Field";var pPrompt="Error: ";var pDate="Invalid Date";var pAlphanumeric="You have typed invalid characters";var pAlphabetic="Invalid string";var pInteger="Invalid number";var pNumber="Invalid number";var pPhoneNumber="Invalid phone number";var pEmail="Invalid email";var pName="Just characters, number or white spaces";var pBlanco="This field can't be left blank.";var pMoney="You must type a money number. \n Check you type only numbers and one decimal point";var pUrl="You have inserted forbidden characters";
var msg;var defaultEmptyOK=false;var digits="0123456789";var lowercaseLetters="()abcdefghijklmnopqrs&?=%"+String.fromCharCode(13)+String.fromCharCode(10)+String.fromCharCode(34)+"tuvwxyzáéíóúüñ.,-_'` :";var uppercaseLetters="ABCDEFGHIJKLMNOPQRSTUVWXYZÁÉÍÓÚÂ½\/ÁÉÍÓÚÜÑ";var urlcar="-()=+áéíóúäëïöüñÑÁÉÍÓÚÄËÏÖÜ&\/&%Â¡Â²Â³Â¤?Â¼Â½ ";var whitespace=" \t\n\r";var phoneChars="()+- ";var diasPorMes=new Array(12);diasPorMes[1]=31;diasPorMes[2]=29;diasPorMes[3]=31;diasPorMes[4]=30;diasPorMes[5]=31;diasPorMes[6]=30;diasPorMes[7]=31;diasPorMes[8]=31;diasPorMes[9]=30;diasPorMes[10]=31;diasPorMes[11]=30;diasPorMes[12]=31;function makeArray(n){for(var i=1;i<=n;i++){this[i]=0;}
return this;}
