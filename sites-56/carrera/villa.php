...
//				if ($('#lic').val() == '') {salida = false; mensaje += "\n"+'El número de licencia no puede quedar vacío';}
				...
				if (categoria.length == 0) {salida = false; mensaje += '<?php echo $idiom[37]; ?>';}
                ...
                if ($("#datos11").val().length > 3 && $("#datos11").val().indexOf('.') > -1) {salida = false; mensaje += '<?php echo $idiom[38]; ?>';}
                if ($("#datos12").val().length > 3 && $("#datos12").val().indexOf('.') > -1) {salida = false; mensaje += '<?php echo $idiom[38]; ?>';}
                if ($("#datos21").val().length > 3 && $("#datos21").val().indexOf('.') > -1) {salida = false; mensaje += '<?php echo $idiom[38]; ?>';}
                if ($("#datos22").val().length > 3 && $("#datos22").val().indexOf('.') > -1) {salida = false; mensaje += '<?php echo $idiom[38]; ?>';}
                if ($("#datos31").val().length > 3 && $("#datos31").val().indexOf('.') > -1) {salida = false; mensaje += '<?php echo $idiom[38]; ?>';}
                if ($("#datos32").val().length > 3 && $("#datos32").val().indexOf('.') > -1) {salida = false; mensaje += '<?php echo $idiom[38]; ?>';}
				
				if (ano > 1920 && ano < 2010) salida = true; else {salida = false; mensaje += '<?php echo $idiom[39]; ?>';}
				
				if ($("#categoria16").attr("checked") && (ano < 2001 || ano > 2004)) {salida = false; mensaje += '<?php echo $idiom[40]; ?>';}
				if ($("#categoria20").attr("checked") && (ano < 1998 || ano > 2000)) {salida = false; mensaje += '<?php echo $idiom[40]; ?>';}
				if ($("#categoria15").attr("checked") && (ano < 2001 || ano > 2004)) {salida = false; mensaje += '<?php echo $idiom[40]; ?>';}
				if ($("#categoria19").attr("checked") && (ano < 1998 || ano > 2000)) {salida = false; mensaje += '<?php echo $idiom[40]; ?>';}
		...
		<div id="div2">
			...
			<div class="intern">
				...
				<div class="divid masc">
					...
					<input type="checkbox" name="categoria[]" class="cambiCheq" id="categoria1" value="100m|35" /><label class="catG" for="categoria1" >100m</label>10,60<br />
					<input type="checkbox" name="categoria[]" class="cambiCheq" id="categoria2" value="200m|36" /><label class="catG" for="categoria2" >200m</label>21,30<br />
					...
					<input type="checkbox" name="categoria[]" class="cambiCheq uniq" id="categoria16" value="600m|47" /><label class="catG1" for="categoria16" >600m <?php echo $idiom[34]; ?></label><br />
					<input type="checkbox" name="categoria[]" class="cambiCheq uniq" id="categoria20" value="600m|48" /><label class="catG1" for="categoria20" >600m <?php echo $idiom[35]; ?></label><br />
					<input type="checkbox" name="categoria[]" class="cambiCheq" id="categoria4" value="800m|37" /><label class="catG" for="categoria4" >800m</label>1,48,50<br />
					...
					<input type="checkbox" name="categoria[]" class="cambiCheq" id="categoria5" value="1500m|38" /><label class="catG" for="categoria5" >1500m</label>3,40,50<br />
					<input type="checkbox" name="categoria[]" class="cambiCheq" id="categoria6" value="5000m|39" /><label class="catG" for="categoria6" >5000m</label>13,50<br />
					...
					<input type="checkbox" name="categoria[]" class="cambiCheq" id="categoria8" value="Triple|40" /><label class="catG" for="categoria8" >Triple</label>15,50m<br />
					<input type="checkbox" name="categoria[]" class="cambiCheq" id="categoria17" value="Pertiga|41" /><label class="catG" for="categoria17" ><?php echo $idiom[36]; ?></label>5,00m<br />
				</div>
				<div class="divid fem">
					<!--<img src="images/mujer<?php echo $lan; ?>.gif" />-->
					<span class="prueba"><?php echo $idiom[12]; ?></span><span class="prueba"><?php echo $idiom[13]; ?></span><br />
					<input type="checkbox" name="categoria[]" class="cambiCheq2" id="categoria9" value="200m|42" /><label class="catG" for="categoria9" >200m</label>24,50<br />
					<input type="checkbox" name="categoria[]" class="cambiCheq2 uniq" id="categoria15" value="600m|49" /><label class="catG1" for="categoria15" >600m <?php echo $idiom[34]; ?></label><br />
					<input type="checkbox" name="categoria[]" class="cambiCheq2 uniq" id="categoria19" value="600m|50" /><label class="catG1" for="categoria19" >600m <?php echo $idiom[35]; ?></label><br />
					<input type="checkbox" name="categoria[]" class="cambiCheq2" id="categoria10" value="800m|43" /><label class="catG" for="categoria10" >800m</label>2,06,00<br />
<!--					<input type="checkbox" name="categoria[]" class="cambiCheq2" id="categoria14" value="1000m|21" /><label class="catG1" for="categoria14" >1000m <?php echo $idiom[34]; ?></label><br />-->
					<input type="checkbox" name="categoria[]" class="cambiCheq2" id="categoria11" value="5000m|44" /><label class="catG" for="categoria11" >5000m</label>16,15,00<br />
					<input type="checkbox" name="categoria[]" class="cambiCheq2" id="categoria12" value="Triple|45" /><label class="catG" for="categoria12" >Triple</label>12,60m<br />
					<input type="checkbox" name="categoria[]" class="cambiCheq2" id="categoria18" value="Pertiga|46" /><label class="catG" for="categoria18" ><?php echo $idiom[36]; ?></label>3,80m<br />
				</div>
			</div>
			<span class="oblig"><?php echo $idiom[10]; ?></span>
		</div>
			...
			<div class="intern">
				<div class="intForm">
					...
					<div style="width: 115px;margin-right: 20px;">
						<?php echo $idiom[23]; ?><br /><input style="width: 100%" type="text" id="datos11" /><br /><input style="width: 100%" type="text" id="datos12" />
					</div>
					<div style="width: 115px;margin-right: 20px;">
						<?php echo $idiom[24]; ?><br /><input style="width: 100%" type="text" id="datos21" /><br /><input style="width: 100%" type="text" id="datos22" />
					</div>
					<div style="width: 115px;">
						<?php echo $idiom[25]; ?><br /><input style="width: 100%" type="text" id="datos31" /><br /><input style="width: 100%" type="text" id="datos32" />
					</div>
