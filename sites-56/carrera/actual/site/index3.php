...
if ($_POST['export'] == 'csv') {
	...
	$contenido = "Id,Atleta Nombre y Apellidos,Repres. Nombre y Apellidos,Tel. Móvil,Correo,Sexo,Año Nac.,Club,Licencia no.,Prueba1,Marca 2012,Marca 2011,".
					"Marca Personal,Prueba2,Marca 2012,Marca 2011,Marca Personal,Observaciones\n";
	...
	$sql="select a.id, concat(a.nombre,' ',apellidos) atleta, 
			...
			from participantes a where a.idevento = 4";
