...
//			if (discip.length == 2) var even = Array(discip[0].split('|'),discip[1].split('|')); else var even = Array(discip[0].split('|'));
			...
			sOut += '<tr><td class="neg">Licencia:</td><td>'+aData[8]+'</td><td class="neg">DNI: </td><td>'+aData[4]+'</td></tr>';
...
//			}
			sOut += '<tr><td class="neg">Fecha inscr:</td><td colspan="3">'+aData[6]+'</td></tr>';
			sOut += '</table>';
			return sOut;
		}

		$(document).ready(function() {
			var where = ' a.idevento = 8 ';
			var oTable = $('#example').dataTable( {
					"bProcessing": true,
					"bServerSide": true,
					"sPaginationType": "full_numbers",
					"sAjaxSource": "cargamilla2014.php?where="+where,
					"oLanguage": {
