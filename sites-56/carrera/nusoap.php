...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (soapiclient->response has contents of the response)");
			return false;
		}
...
* @access   public
*/
class soapiclient extends nusoap_base  {
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends soapiclient {
	'.$evalStr.'
}';
		return $evalStr;
	}
