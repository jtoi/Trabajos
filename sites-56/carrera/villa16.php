...
// 		}
		...
		function fijaPrueba(){
			var fn = $("#fn").val();
			if ($("#sexo1").attr("checked") == "checked") var sex = 'm';
			else var sex = 'f';
			$(".cambiCheq2").attr("disabled","true").attr("checked",false);
			$(".cambiCheq").attr("disabled","true").attr("checked",false);
			if (fn > 2000 && fn < 2004) {
				if (sex == 'm') $("#categoria20").attr("checked",true).attr("disabled",false);
				else $("#categoria19").attr("checked",true).attr("disabled",false);
			} else {
				if (sex == 'm') $("#categoria16").attr("checked",true).attr("disabled",false);
				else $("#categoria15").attr("checked",true).attr("disabled",false);
			}
		}
...
<div id="todo">
	<div id="todo1">
		...
		<div id="div0">
			<a href="villa16.php?lan=es"><img src="images/es.png" alt="Español" title="Español" /></a>
			<a href="villa16.php?lan=eu"><img src="images/eu.png" alt="Euskera" title="Euskera" /></a>
			<a href="villa16.php?lan=en"><img src="images/en.png" alt="English" title="English" /></a>
		</div>
		<div id="div3">
			<span class="intro"><?php echo $idiom[15]; ?></span>
			<div class="intern">
				<div class="intForm">
					<div style="width: 179px;margin-right: 20px;"><?php echo $idiom[6]; ?> <br /><input style="width: 100%" type="text" id="nombre" /> </div>
					<div style="width: 180px;margin-right: 20px;"><?php echo $idiom[7]; ?><br /><input style="width: 100%" type="text" id="apellido" /></div>
					<div style="width: 100px"><?php echo $idiom[18]; ?>
						<select id="fn" style="width: 100%" >
		...
		<div id="div2">
			...
			<div class="intern">
				...
				<div class="divid masc">
					...
					<input type="checkbox" name="categoria[]" class="cambiCheq" id="categoria13" value="1000m|20" /><label class="catG1" for="categoria13" >1000m</label><br />
