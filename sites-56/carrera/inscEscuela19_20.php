...
$q = "insert into participantes (idevento, atleta, nombre, apellidos, sexo, fnac, direccion, localidad, cp, telf, correo, pais, doc, licencia_num, carnet, observaciones, idprueba, fechaInsc, telfm, idequipo, tipoDoc, club, provincia, pin) values ".
		"(32, 'S', '".$d['nomb']."', '".$d['ape']."', '".$d['sexo']."', '".$feArr[2]."-".$feArr[1]."-".$feArr[0]."', '".$d['direc']."', '".$d['loc']."', '".$d['cp']."', '".$d['tel']."', '".$d['correo']."', '".$d['cole']."', '".$d['dni']."', '".$d['cuota']."', '".$d['carnet']."', '".$d['obs'].
...
$mensaje = "Desde el <strong>Club Bilbao Atletismo Santutxu</strong> queremos daros las gracias por haber pensado en nosotros y apuntar a vuestro hijo/a en la <strong>temporada 2019/2020 de la Escuela de Atletismo.</strong><br><br>El comienzo del curso:<br><br>
Del a&ntilde;o 1999 al 2005: <strong>desde el 02 de septiembre del 2019 (lunes, mi&eacute;rcoles y viernes) de 18:00 a 19:30/20h</strong><br><br>
Del a&ntilde;o 2006 al 2007: <strong>desde el 17 de septiembre del 2019 (martes, jueves y viernes) de 18:00 a 19:30h<br><br>
Del a&ntilde;o 2008 al 2013: <strong>desde el 01 de octubre del 2019 (martes y jueves) de 18:00 a 19:15h<br><br>
...
La semana del 16 de septiembre del 2019 haremos una reuni&oacute;n informativa con los padres/ madres de los ni&ntilde;os apuntados a la escuela. Esta reuni&oacute;n se comunicar&aacute; con la debida antelaci&oacute;n por correo electr&oacute;nico.<br><br>

<strong>Si has seleccionado semana de prueba</strong>, podr&aacute;s probar 2 d&iacute;as siguientes que correspondan a tu categor&iacute;a una vez este rellenado el formulario de inscripci&oacute;n con esa opci&oacute;n. <br><br>
...
$subject = 'Solicitud de inscripci&oacute;n en la Escuela de Atletismo de Bilbao';
//echo "envio-".
