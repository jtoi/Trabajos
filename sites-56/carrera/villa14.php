...
//				if ($('#lic').val() == '') {salida = false; mensaje += "\n"+'El número de licencia no puede quedar vacío';}
				...
				if (ano > 1921 && ano < 2011) salida = true; else {salida = false; mensaje += '<?php echo $idiom[39]; ?>';}
				
				if ($("#categoria16").attr("checked") && (ano < 2002 || ano > 2005)) {salida = false; mensaje += '<?php echo $idiom[40]; ?>';}
				if ($("#categoria20").attr("checked") && (ano < 1999 || ano > 2001)) {salida = false; mensaje += '<?php echo $idiom[40]; ?>';}
				if ($("#categoria15").attr("checked") && (ano < 2002 || ano > 2005)) {salida = false; mensaje += '<?php echo $idiom[40]; ?>';}
				if ($("#categoria19").attr("checked") && (ano < 1999 || ano > 2001)) {salida = false; mensaje += '<?php echo $idiom[40]; ?>';}
