...
$feArr = explode("/", $d['fn']);
if ($d['cuota'] == 1) $cuota = 'trimestral';
if ($d['cuota'] == 2) $cuota = 'mensual';
if ($d['cuota'] == 3) $cuota = 'semanal';
//		inserta atleta
$q = "insert into participantes (idevento, atleta, nombre, apellidos, sexo, fnac, direccion, localidad, cp, telf, correo,
		...
		"(6, 'S', '".$d['nomb']."', '".$d['ape']."', 'F', '".$feArr[2]."-".$feArr[1]."-".$feArr[0]."', '".$d['direc']."', '".$d['loc']."', '".$d['cp']."', '".$d['tel']."', '".$d['correo'].
...
$mensaje = "Tu solicitud de inscripción ha sido recibida correctamente, en los próximos días recibirás un correo del Club Bilbao Atletismo Santutxu para aceptar tu inscripción en la Escuela de Atletismo de Bilbao".
			".<br><br>".
