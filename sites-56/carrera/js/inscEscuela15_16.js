...
$(document).ready(function(){
	...
	$(".cate").click(function(){
		if ($(".cate:checked").val() == 102 || $(".cate:checked").val() == 103 || $(".cate:checked").val() == 104 || $(".cate:checked").val() == 105 ){
			$("#2di").hide();
			$("#cuota5").attr("checked","");
		} else {
			$("#2di").show();
			$("#cuota1").attr("checked","checked");
		}
	});
...
//		alert(anos);
		if ($("#categoria8").attr('checked') && (anos == '2010' || anos == '2011')) return false;
		if ($("#categoria4").attr('checked') && (anos == '2009' || anos == '2008')) return false;
		if ($("#categoria2").attr('checked') && (anos == '2006' || anos == '2007')) return false;
		if ($("#categoria3").attr('checked') && (anos == '2004' || anos == '2005')) return false;
		if ($("#categoria5").attr('checked') && (anos == '2002' || anos == '2001')) return false;
		if ($("#categoria6").attr('checked') && (anos == '2000' || anos == '1999')) return false;
		if ($("#categoria1").attr('checked') && (anos == '2003')) return false;
		else return true
	}
...
//		if (!$("#tel").val().match(/^\[0-9\s(-)]*$/)) mensaje += "\nDebe poner un n\xfamero de tel\xe9fono v\xe1lido";
		...
		if (mensaje.length == 0) {
			...
			$("#envia").hide();
			//alert($("#tel").val());
			$("#result").load('inscEscuela15_16.php', {
				catego: cate
				,cuota: cotta
				,club: club
