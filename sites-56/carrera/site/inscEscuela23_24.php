...
//			if (discip.length == 2) var even = Array(discip[0].split('|'),discip[1].split('|')); else var even = Array(discip[0].split('|'));
		...
		$(document).ready(function() {
			var where = ' a.idevento = 39 and a.id = r.idparticipante ';
	...
	<div class="content">
		...
		<div class="search_field">
			<form method="post" action="">
				<span class="clEven" style="margin-right: 112px;" >Evento: Escuela de Atletismo de Bilbao 2023 - 2024<!-- <select id="even" name="even">
