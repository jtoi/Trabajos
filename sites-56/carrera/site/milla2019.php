...
if ($_POST['export'] == 'csv') {
	...
	$contenido = "Id,Atleta Nombre,Fecha Nac.,DNI, CP, Correo,Licencia no.,Categoría,Sexo,Club,Teléfono,Carnet Plus\n";
	...
	$sql="select a.id, concat(a.nombre, ' ', a.apellidos) atleta, date_format(fnac, '%d/%m/%Y') fnac, tipoDoc, cp, correo, licencia_num, ".
				...
				"from participantes a, prueba p where a.idevento = 30 and p.id = a.idprueba";
// echo $sql;exit();
