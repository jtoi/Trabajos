...
if ($_POST['export'] == 'csv') {
	...
	$contenido = "Id,Atleta Nombre y Apellidos,Repres. Nombre y Apellidos,Tel. Móvil,Correo,Sexo,Año Nac.,Club,Licencia no.,Prueba1,Marca 2013,Marca 2012,".
					"Marca Personal,Prueba2,Marca 2013,Marca 2012,Marca Personal,Observaciones\n";
	...
	$sql="select a.id, concat(a.nombre,' ',apellidos) atleta, 
			...
			from participantes a where a.idevento = 10";
...
//			if (discip.length == 2) var even = Array(discip[0].split('|'),discip[1].split('|')); else var even = Array(discip[0].split('|'));
			...
			sOut += '<tr><td class="neg cen">Prueba</td><td class="neg cen">Marca 2012</td><td class="neg cen">Marca 2011</td><td class="neg cen">Marca Personal</td></tr>';
