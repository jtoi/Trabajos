...
if ($_REQUEST['tabla']) {
	...
	$aColumns = array( 'a.id', 
						...
						'case locate("22|",direccion) when 1 then "Otros d&iacute;as y horarios" else "Lunes Mi&eacute;rcoles y Viernes" end', 
						'case pin when "Si" then "30 &euro;" else "36 &euro;" end', 
						'carnet',
