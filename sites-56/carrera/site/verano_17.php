...
if ($_POST['export'] == 'csv') {
	...
	$contenido = "Id;Alumno Nombre y Apellidos;Categoría;Fecha Nac.;Semanas;Tel.;Correo;Direccion;Localidad;CP;DNI;Colegio;Observaciones;Carnet Kirolak;".
	...
	$sql = 'SELECT a.id, upper(concat(a.nombre, " ", apellidos)) alumno, a.provincia cat, date_format(fnac, "%e/%c/%Y") fn, licencia_num, telf, a.correo, '.
		...
		where  a.idevento = 22 and a.id = r.idparticipante';
// echo $sql;
...
//			sOut += '<tr><td>'+even[i][0]+'</td><td>'+even[i][1]+'</td><td>'+even[i][2]+'</td><td>'+even[i][3]+'</td></tr>';
		...
		$(document).ready(function() {
			var where = ' a.idevento = 22 and a.id = r.idparticipante ';
