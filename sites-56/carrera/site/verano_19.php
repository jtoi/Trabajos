...
if (isset($_POST['export']) && $_POST['export'] == 'csv') {
	...
	$contenido = "Id;Alumno Nombre y Apellidos;Categoria;Fecha Nac.;Semanas;Tel.;Correo;Direccion;Localidad;CP;DNI;Colegio;Observaciones;Carnet Kirolak;".
						"Fecha Inscripcion;Tutor;DNI Tutor\n";
