...
if ($_POST['export'] == 'csv') {
	...
	$sql="select a.id, upper(concat(a.nombre, ' ', a.apellidos)) atleta, r.nombre represent, date_format(fnac, '%Y') ano, r.tel, r.correo, licencia_num, ".
				...
				"from participantes a, prueba p, representantes r where a.idevento = 29 and r.idparticipante = a.id and p.id = a.idprueba";
// echo $sql;
