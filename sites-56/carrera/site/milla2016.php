...
//			if (discip.length == 2) var even = Array(discip[0].split('|'),discip[1].split('|')); else var even = Array(discip[0].split('|'));
			...
			sOut += '<tr><td class="neg">Correo:</td><td><a href="mailto:'+aData[10]+'">'+aData[10]+'</a></td><td class="neg">C&oacute;digo Postal:</td><td>'+aData[5]+'</td></tr>';
...
//			}
		...
		$(document).ready(function() {
			var where = ' a.idevento = 16 ';
			var oTable = $('#example').dataTable( {
					"bProcessing": true,
					"bServerSide": true,
					"sPaginationType": "full_numbers",
					"sAjaxSource": "cargamilla2016.php?where="+where,
					"oLanguage": {
