...
function ValidDayMonth(dayNum, monthNum, yearNum){
	...
	if ((monthNum > 12) || (yearNum < (aano-14)) || (yearNum > (aano-6)))return false;
...
function cambiaPrecio(){
	if ($("#cuota1").attr("checked")){
		$("#precio1").text("(90\u20ac/trimestre)"); 
		$("#precio2").text("(72\u20ac/trimestre)");
		$("#kirolak1").css("width",140);
	}
	if ($("#cuota2").attr("checked")){
		$("#precio1").text("(30\u20ac/mes)"); 
		$("#precio2").text("(24\u20ac/mes)");
		$("#kirolak1").css("width",140);
	}
	if ($("#cuota3").attr("checked")){
		$("#precio1").text("(completamente gratis)"); 
		$("#precio2").text("(completamente gratis)");
		$("#kirolak1").css("width",190);
	}
}
