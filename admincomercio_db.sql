...
INSERT INTO `tit_Relacion` VALUES (1,1,2,1,226314),(2,1,2,20,226315),(3,4,5,9,230722),(4,4,5,20,230723),(5,7,8,1,226460),(6,7,8,20,226461),(7,7,9,1,226589),(8,7,9,20,226590);
...
CREATE TABLE `tit_TipoDocumento` (
  ...
  `Nombre` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `defecto` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`Id`),
  KEY `IdGrupo` (`IdGrupo`),
...
INSERT INTO `tit_TipoDocumento` VALUES (1,1,'National Identity Card',1),(2,1,'Passport',1),(3,1,'Residence Card',1),(4,1,'Fiscal Code (Italy)',1),(5,1,'National ID',1),(6,1,'Driving License',1),(7,1,'Representation Authorization',1),(8,1,'Tax Identification Code',1),(9,1,'Memorandum of Association',1),(10,1,'Articles of Incorporation',1),(11,1,'Power of Attorney',1),(12,1,'Actual Ownership',1),(13,2,'Contract',0),(14,3,'Payroll',0),(15,3,'Autonomous Payment',0),(16,2,'Invoices',0),(17,2,'Bank Statement',0),(18,4,'Account Ownership',0),(19,2,'Purchase/Sale',0),(20,2,'Loans',0),(21,2,'Cancellation of Deposits/Investment',0),(22,3,'Personal Income Tax Return',0),(23,3,'Corporate Income Tax',0),(24,3,'VAT Return',0),(25,1,'Foreign Identity Number',1),(26,2,'Economic activity registration document',0),(27,6,'Contract with Titanes',0),(28,2,'Contract with Booking',0),(29,1,'Proof of life',1),(30,2,'Other Sources of Funds',0),(31,7,'Other Documents',0),(32,3,'Self-Employed Code',0);
...
INSERT INTO `tit_Token` VALUES (17,'cUgLUZvWW4hb9kak0v6ZVMjZsx_5pzzbqnq3FUV1IukNxD2Gc0-u3T490TSE6xxOtIIyIHIq82jZrmgigbwCzysdHyhP6eULgHC1_5urIem1ZYuS9RaWZhuNWdD-QqOcz2X74f-uLekDd-nCr8B2Xf0QiPq3x_zjGoZpNB_KKxfTQFmFs6nzahYqB-RXRwKlvbyGwNv7KNWJXUn6bZ9a6otB_6E6L4S2jqQp0GPp8EXtF90SJAFq7TzQRAou-v9Qiwhm0oWekriyIt9opYXx_ZgFBTcI_h_oCLUtmjWUn1jM2zMEaPvHxHC46X1ASSfmix3i_kPmzxtvXFfQh2-sjIXlbDtXVSfLmdjRfidPBOzghQBihzsEYCTCfNGe7s09gkIz0aujguXHTnvRTEJvac9DBdo-hJFndUpkwGA7nBpcokIXcRF_X-XYaZV_mcj9o3ji2ZkELRVBcCC5fB9yt4iyvML8JNk8KbNC0uuCo40Vnj8L_9Cdtdk6W7_krOlK1-0pRF937ubUjJUcppdLXOIIrrsJy69dGTq9Y1TaCB8EHiv9YkM8UGBk_DFtfNVkqJrEzq59zDOY_1-1MWVaVOB1_i-Cn8Ywzaj3F8Hb73fVUVmgKmwzjAKpMQwlExzZ','2023-11-24');
...
-- Dump completed on 2023-11-29 19:42:16
