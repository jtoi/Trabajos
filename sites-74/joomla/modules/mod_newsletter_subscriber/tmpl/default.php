...
# Websites: https://www.mavrosxristoforos.com
# Technical Support:  Forum - https://www.mavrosxristoforos.com/support/forum
-------------------------------------------------------------------------*/
  ...
  <form method="post" <?php print $action; ?>>
    ...
    <div class="modns_form">
      ...
      <?php if ($anti_spam_position == 1) { // Anti-Spam After ?>
        <div id="antiSp" class="input-group"><?php print $anti_spam_field; ?></div>
      <?php } ?>
